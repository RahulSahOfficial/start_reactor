...
var tap=new Audio("files/audio/tapsound.ogg")
var wintune = new Audio("files/audio/win.mp3")
var wrong = new Audio("files/audio/wrong.ogg")
var completed=new Audio("files/audio/completed.mp3")
